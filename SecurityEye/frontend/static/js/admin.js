...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    try {
        // ⭐ CAMBIAR: De "http://localhost:8000/admin/all-sessions" a `${window.API_URL}/admin/all-sessions`
        const sessionsUrl = `${window.API_URL}/admin/all-sessions`;
        console.log('Cargando sesiones desde:', sessionsUrl);
